...
export const MAPAS_MENTALES_PLANTILLA: MapaMentalPlantilla[] = [
  ...
  },
  {
    ...
    nodos: [
      ...
      { id: 'clases', texto: 'Clases de omisión', forma: 'rectangulo', tamanoTexto: 'subtitulo' },

      { id: 'pura', texto: 'Omisión pura o propia', forma: 'ovalo', tamanoTexto: 'subtitulo' },
      { id: 'pura-def', texto: 'Omisión del deber de socorro — infringe directamente la norma imperativa', forma: 'rectangulo', tamanoTexto: 'texto' },
      { id: 'pura-elem', texto: 'Elementos', forma: 'ovalo', tamanoTexto: 'texto' },
      ...
      { id: 'pura-subj-1', texto: 'Dolo: saber y querer no ayudar (no admite modalidad imprudente)', forma: 'rectangulo', tamanoTexto: 'texto' },
      { id: 'pura-subj-2', texto: 'Condiciones especiales de autoría', forma: 'rectangulo', tamanoTexto: 'texto' },

      { id: 'comision', texto: 'Comisión por omisión', forma: 'ovalo', tamanoTexto: 'subtitulo' },
      { id: 'comision-def', texto: 'No evitar un resultado lesivo que el sujeto debía impedir', forma: 'rectangulo', tamanoTexto: 'texto' },
      { id: 'garante', texto: 'Posición de garante', forma: 'rombo', tamanoTexto: 'texto' },
      ...
      { id: 'comision-elem', texto: 'Elementos', forma: 'rectangulo', tamanoTexto: 'texto' },
      ...
      { id: 'comision-subj-2', texto: 'Imprudencia, solo si está tipificada expresamente', forma: 'rectangulo', tamanoTexto: 'texto' },
